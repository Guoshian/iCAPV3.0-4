...
#define TUN_MAXMSG 1500// bytes (device)
...
#define TCP_RECV_WINDOW 1448// bytes (maximum)
#define TCP_SEND_WINDOW 1448 // bytes (maximum)
...
#define MAX_PCAP_RECORD 1500 //bytes
...
void write_pcap_rec_ip(const uint8_t *pkt, size_t len);
